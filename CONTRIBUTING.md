# Contributing to `attackmap-analyzer-atproto`
...
```bash
git clone https://github.com/mlaify/attackmap-analyzer-atproto.git
cd attackmap-analyzer-atproto
python -m venv .venv
...
Open a [bug report](https://github.com/mlaify/attackmap-analyzer-atproto/issues/new?template=bug_report.md).
...
Open a [feature request](https://github.com/mlaify/attackmap-analyzer-atproto/issues/new?template=feature_request.md).
...
By contributing to `attackmap-analyzer-atproto`, you agree that your contributions will be
